 ...
 * `doc` must be valid and have at least one page.
 */
int pdf_page_set_line_width(PdfDocument *doc, double width);
 ...
 * `doc` must be valid and have at least one page.
 */
int pdf_page_rect(PdfDocument *doc, double x, double y, double width, double height);
 ...
 */
int pdf_document_write(PdfDocument *doc, unsigned char **out_ptr, uintptr_t *out_len);
 ...
 * `doc` must be a valid handle.
 */
int pdf_document_set_default_size(PdfDocument *doc, double width, double height);
 ...
 */
int pdf_document_set_info(PdfDocument *doc,
                                const char *title,
                                const char *author,
                                const char *subject,
                                const char *keywords,
 ...
 * `doc` must be a valid handle.
 */
int pdf_document_add_page_sized(PdfDocument *doc, double width, double height);
 ...
 */
int pdf_page_show_text(PdfDocument *doc,
                             int font,
                             double size,
                             double x,
                             double y,
 ...
 * `doc` must be valid with at least one page; `text` a valid C string.
 */
int pdf_page_paragraph(PdfDocument *doc,
                             int font,
                             double size,
                             double x,
                             double y,
 ...
 */
int pdf_document_add_image_png(PdfDocument *doc,
                                     const uint8_t *data,
                                     uintptr_t len,
                                     int *out_id);
 ...
 * `doc`, `data`, `out_id` must be valid.
 */
int pdf_document_add_image_jpeg(PdfDocument *doc,
                                      const uint8_t *data,
                                      uintptr_t len,
                                      int *out_id);
 ...
 */
int pdf_page_figure(PdfDocument *doc,
                          int image,
                          double x,
                          double y,
                          double w,
 ...
 */
int pdf_document_attach_file(PdfDocument *doc,
                                   const char *name,
                                   const char *mime,
                                   const uint8_t *data,
                                   uintptr_t len,
 ...
 */
int pdf_document_text_field(PdfDocument *doc,
                                  const char *name,
                                  uintptr_t page,
                                  double x0,
                                  double y0,
 ...
 */
int pdf_document_checkbox(PdfDocument *doc,
                                const char *name,
                                uintptr_t page,
                                double x0,
                                double y0,
 ...
 */
int pdf_document_dropdown(PdfDocument *doc,
                                const char *name,
                                uintptr_t page,
                                double x0,
                                double y0,
 ...
 */
int pdf_document_radio_group(PdfDocument *doc,
                                   const char *name,
                                   uintptr_t page,
                                   uintptr_t count,
                                   const double *rects,
 ...
 */
int pdf_editable_extract_pages(const PdfEditable *ed,
 ...
 */
int pdf_editable_get_info(const PdfEditable *ed,
                                const char *key,
 ...
 */
int pdf_editable_overlay_page(PdfEditable *ed,
                                    uintptr_t index,
 ...
 */
int pdf_editable_fill_text_field(PdfEditable *ed,
                                       const char *name,
                                       const char *value,
                                       int *out_found);
 ...
 */
int pdf_editable_fill_rect(PdfEditable *ed,
                                 int index,
                                 double x,
                                 double y,
                                 double width,
 ...
 */
int pdf_editable_place_text(PdfEditable *ed,
                                  int index,
                                  double x,
                                  double y,
                                  const char *text,
 ...
 * `ed`, `text` valid; `out_found` writable or NULL.
 */
int pdf_editable_place_text_font(PdfEditable *ed,
                                       int index,
                                       double x,
                                       double y,
                                       const char *text,
 ...
 * `ed`, `text` valid; `out_found` writable or NULL.
 */
int pdf_editable_masked_text_font(PdfEditable *ed,
                                        int index,
                                        double x,
                                        double y,
                                        double width,
 ...
 * `ed`, `text` valid; `out_found` writable or NULL.
 */
int pdf_editable_place_text_anchored(PdfEditable *ed,
                                           int index,
                                           double x,
                                           double y,
                                           const char *text,
 ...
 * `ed`, `text` valid; `out_found` writable or NULL.
 */
int pdf_editable_masked_text_valign(PdfEditable *ed,
                                          int index,
                                          double x,
                                          double y,
                                          double width,
 ...
 */
int pdf_editable_place_paragraph(PdfEditable *ed,
                                       int index,
                                       double x,
                                       double y,
                                       double width,
 ...
 */
int pdf_editable_draw_image_anchored(PdfEditable *ed,
                                           int index,
                                           const uint8_t *data,
                                           uintptr_t len,
                                           double x,
 ...
 */
int pdf_editable_place_paragraph_anchored(PdfEditable *ed,
                                                int index,
                                                double x,
                                                double y,
                                                double width,
 ...
 * `ed`, `text` valid; `out_found` writable or NULL.
 */
int pdf_editable_masked_text_pad(PdfEditable *ed,
                                       int index,
                                       double x,
                                       double y,
                                       double width,
 ...
 * `ed`, `user`, `owner` valid.
 */
int pdf_editable_encrypt(PdfEditable *ed,
                               int method,
                               const char *user,
                               const char *owner,
                               int read_only);
 ...
 * `ed`, `out_ptr`, `out_len` valid.
 */
int pdf_editable_to_bytes(const PdfEditable *ed, unsigned char **out_ptr, uintptr_t *out_len);
 ...
 */
int pdf_editable_to_bytes_incremental(const PdfEditable *ed,
 ...
 * `ed`, `path` valid.
 */
int pdf_editable_save(const PdfEditable *ed, const char *path);
 ...
 * `data`/`len` readable; `out_ptr`/`out_len` writable.
 */
int pdf_measure_pages_json(const uint8_t *data,
                                 uintptr_t len,
                                 unsigned char **out_ptr,
                                 uintptr_t *out_len);
 ...
 * `data`/`len` readable; `out_ptr`/`out_len` writable.
 */
int pdf_inspect_json(const uint8_t *data,
                           uintptr_t len,
                           unsigned char **out_ptr,
                           uintptr_t *out_len);
 ...
 * `out_ptr`/`out_len` writable.
 */
int pdf_sign(const uint8_t *pdf,
                   uintptr_t pdf_len,
 ...
 */
int pdf_timestamp(const uint8_t *pdf,
                        uintptr_t pdf_len,
                        const uint8_t *key_der,
                        uintptr_t key_len,
                        const uint8_t *cert_der,
 ...
 */
int pdf_add_dss(const uint8_t *pdf,
                      uintptr_t pdf_len,
